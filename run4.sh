...
rm -rf ./*db.lock
rm -rf ./log/*.csv
go run main.go -S 4 -f 1 -c -t len3.csv &
...
go run main.go -S 4 -f 1 -s S0 -n N0 -t len3.csv &
go run main.go -S 4 -f 1 -s S1 -n N0 -t len3.csv &
go run main.go -S 4 -f 1 -s S2 -n N0 -t len3.csv &
go run main.go -S 4 -f 1 -s S3 -n N0 -t len3.csv &
